...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://bfau5ukhwa.execute-api.us-east-1.amazonaws.com/photo';
    ...
    apigClient.fileuploadOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var fileuploadOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/{fileupload+}').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(fileuploadOptionsRequest, authType, additionalParams, config.apiKey);
    };
